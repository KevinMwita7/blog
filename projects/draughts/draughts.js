...
function findWasmBinary() {
  return locateFile('draughts.wasm');
}
...
var _dr_command = Module['_dr_command'] = makeInvalidEarlyAccess('_dr_command');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['dr_command'] != 'undefined', 'missing Wasm export: dr_command');
  ...
  _dr_command = Module['_dr_command'] = createExportWrapper('dr_command', wasmExports['dr_command'], 1);
